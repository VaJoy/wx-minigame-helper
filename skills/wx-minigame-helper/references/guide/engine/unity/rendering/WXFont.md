...
source: https://developers.weixin.qq.com/minigame/dev/guide/game-engine/unity-webgl-transform/Design/WXFont.html
---
...
若不满足客户端版本要求，首次从网络下载；当符合缓存规则时，后续从[本地文件缓存加载](<../assets/FileCache.md>)，因此必须提供 CDN 后备字体。

## 代码示例

详细示例可参考[系统字体demo](<https://git.weixin.qq.com/wechat-minigame/minigame-tuanjie-demo/tree/master/Demo/WX_Font>)
...
## 相关日志
  ...
  * 打开[插件调试日志](<../assets/UsingLoader.md>)
...
![](https://res8.wxqcloud.qq.com.cn/wxdoc/7ba4c807-2bf3-4ecb-8ba8-34bdeb887608.png)

注：考虑到小游戏在安卓设备上的内存压力通常较小，并且裁剪本身也有计算消耗。因此**安卓设备上的小游戏不会做字符裁剪，而是直接读取系统的字体** 。
