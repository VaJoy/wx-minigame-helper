...
source: https://developers.weixin.qq.com/minigame/dev/guide/game-engine/unity-webgl-transform/Design/LaunchOpera.html
---
...
[演示工程源码](<https://git.weixin.qq.com/wechat-minigame/minigame-tuanjie-demo/tree/master/Demo/LaunchOpera>)
...
魔魔打勇士 | 飞翔之光 | 镜花异闻录  
---|---|---  
![](https://res8.wxqcloud.qq.com.cn/wxdoc/945a5f22-fec7-4600-873c-af1d1e1d09c2.jpeg) | ![](https://res8.wxqcloud.qq.com.cn/wxdoc/a730f3bd-c5ab-4113-ac14-b29da352db2f.jpeg) | ![](https://res8.wxqcloud.qq.com.cn/wxdoc/423bb4db-f8ee-4939-9615-049d0ef5192c.jpeg)  
...
剧本设计请阅读 [启动剧情剧本自助设计工具及文档](<https://developers.weixin.qq.com/minigame/dev/guide/game-engine/unity-webgl-transform/Design/LaunchOperaDocument.html>) 完成设计与调试；
...
![](https://res8.wxqcloud.qq.com.cn/wxdoc/ce3442b9-ac42-4265-b93d-76fac5ec62a3.png)
...
启动剧情是一个持续较长时间的业务内容，这段时间中任何时刻均会有用户离开，因此上报剧情期间用户不同阶段的行为对于分析剧情内容与留存率是非常重要的。启动剧情的“剧本”由开发者定义，因此开发者更清楚一个剧情的不同阶段的时间点，所以需要开发者自行对不同阶段剧情进行上报打点。开发者配置上报后，MP管理后台提供了漏斗图的数据可视化看板，将方便开发者进行数据分析。 有关自定义上报详细内容请参考 [启动场景上报分析](<../../../performance/startup/perf-action-start-reportScene.md>) 。

### 外显进度条接入

启动剧情能力工作期间，仍然提供了加载进度外显能力，这有助于在剧情播放期间通过截图方式反馈一些加载进度信息，默认情况下位于小游戏底部区域，如图所示：

![](https://res8.wxqcloud.qq.com.cn/wxdoc/071f270a-c676-4aac-88b1-029627f81877.png)
