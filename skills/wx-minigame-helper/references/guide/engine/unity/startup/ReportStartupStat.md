...
source: https://developers.weixin.qq.com/minigame/dev/guide/game-engine/unity-webgl-transform/Design/ReportStartupStat.html
---
...
在小游戏环境下，玩家对启动时长与体验非常敏感（尤其从“广告”等买量场景进入的玩家）。开发者往往需要分析玩家从点击到进入游戏核心玩法的整个过程流失率。 [Unity Loader](<../assets/UsingLoader.md>)的数据统计功能如下：
...
为了详细统计玩家的流失情况以便开发者进行优化，我们拆分了三个部分。 ![](https://res8.wxqcloud.qq.com.cn/wxdoc/e86eff8f-0970-455d-98b1-bb582ab32278.png) 其中**自动上报** 为Unity Loader自动完成开发者无需关注，但**自定义阶段** 与**启动加载完成** 需开发者主动调用接口进行上报。详细接口可参考C# SDK中的WX.cs，文档可查看[启动场景上报分析](<../../../performance/startup/perf-action-start-reportScene.md>) 及 [wx.reportScene](<https://developers.weixin.qq.com/minigame/dev/api/data-analysis/wx.reportScene.html>)
...
数据报表统计分析请参考文档[启动场景上报分析-数据分析](<../../../performance/startup/perf-action-start-reportScene.md>) 进行查看。

![](https://res8.wxqcloud.qq.com.cn/wxdoc/fc69e7f7-828d-44b9-a351-e33e98df5d6d.png) ![](https://res8.wxqcloud.qq.com.cn/wxdoc/e579e0bb-1e74-405c-9c82-c049dbcabd9f.png)

_**注：**_

  1. 若使用的 `转换插件版本<202211101011`（对应`Unity Loader版本<1.1.2`），数据统计报表需要[联系我们](<../getting-started/IssueAndContact.md>)获取。
