...
source: https://developers.weixin.qq.com/minigame/dev/guide/game-engine/unity-webgl-transform/Design/InputAdaptation.html
---
...
详细示例请参考[API Demo](<https://git.weixin.qq.com/wechat-minigame/minigame-tuanjie-demo/tree/master/Demo/API_V2>)
