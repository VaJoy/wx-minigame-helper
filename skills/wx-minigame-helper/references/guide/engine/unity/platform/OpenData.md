---
title: "Unity中如何展示排行榜这类微信关系数据"
type: guide
category: guide/engine/unity/platform
source: https://developers.weixin.qq.com/minigame/dev/guide/game-engine/unity-webgl-transform/Design/OpenData.html
---
...
小游戏提供了[一系列接口](<https://developers.weixin.qq.com/minigame/dev/api/open-api/data/wx.shareMessageToFriend.html>)获取好友关系链数据，为了安全，绝大部分接口都只能在[开放数据域](<../../../open-ability/data/opendata/basic.md>)内调用。

![avatar](https://res8.wxqcloud.qq.com.cn/wxdoc/f5310496-9726-4994-869c-1eaf83c91b5e.png)
...
**重点更新：** **我们在基础库3.6.6版本支持了 ScreenCanvas 模式的开放数据域**
...
![avatar](https://res8.wxqcloud.qq.com.cn/wxdoc/9db8dc1b-97bf-4fe4-a776-362a74e4c94b.png)
...
![avatar](https://res8.wxqcloud.qq.com.cn/wxdoc/680f0ae0-6240-4503-b5c9-c67dff204046.png)
...
可以参考[Demo/Ranking](<https://git.weixin.qq.com/wechat-minigame/minigame-tuanjie-demo/tree/master/Demo/Ranking>)下面的Unity工程。插件导出的 open-data 已经是一个比较功能完备的工程，进行简单的魔改就能够满足需求。
...
![](https://res8.wxqcloud.qq.com.cn/wxdoc/bb841f0a-eae8-431c-82e0-f647e1b00dad.jpeg) ![](https://res8.wxqcloud.qq.com.cn/wxdoc/9e932b7d-c693-4777-8e73-38a6b00cd616.jpeg) ![](https://res8.wxqcloud.qq.com.cn/wxdoc/dd7c3602-bfa7-4228-ba08-fa12a161e288.jpeg)
...
![](https://res8.wxqcloud.qq.com.cn/wxdoc/1053ce3c-8a68-4e96-a4f0-c8fe11cc1851.jpeg) ![](https://res8.wxqcloud.qq.com.cn/wxdoc/5d239e72-d970-4d15-8470-eb73c0776b23.jpeg) ![](https://res8.wxqcloud.qq.com.cn/wxdoc/6baa1839-4cd6-4732-a917-d7833a63f647.jpeg) ![](https://res8.wxqcloud.qq.com.cn/wxdoc/675fd976-2f92-4ccd-a110-5d86534cf6e8.jpeg)
...
**Q4. 为什么使用ScreenCanvas模式之后，ToTempFilePath没有开放数据域的画面了？**
  ...
  * 因为ScreenCanvas模式的画布是浮在游戏主画布之上的，并不是同一个画布，如需保存开放数据域画面，需要使用`WXSharedCanvas.ToTempFilePath`，使用示例参考[示例](<https://git.weixin.qq.com/wechat-minigame/minigame-tuanjie-demo/tree/master/Demo/Ranking>)
