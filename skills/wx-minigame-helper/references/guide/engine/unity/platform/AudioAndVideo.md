...
source: https://developers.weixin.qq.com/minigame/dev/guide/game-engine/unity-webgl-transform/Design/AudioAndVideo.html
---
...
在微信小游戏中有两种播放视频的方式，目前 VideoPlayer 组件已自动适配微信小游戏，只有全屏视频的场景也可以选择使用[WXVideo API](<https://git.weixin.qq.com/wechat-minigame/minigame-tuanjie-demo/tree/master/Demo/WX_Video>)
...
### QA
  ...
  * 如果只是单纯使用全屏的视频播放，更推荐使用小游戏 API 视频播放能力。请参考[小游戏开发者文档](<https://developers.weixin.qq.com/minigame/dev/api/media/video/wx.createVideo.html>)以及示例[Video Demo](<https://git.weixin.qq.com/wechat-minigame/minigame-tuanjie-demo/tree/master/Demo/WX_Video>)
