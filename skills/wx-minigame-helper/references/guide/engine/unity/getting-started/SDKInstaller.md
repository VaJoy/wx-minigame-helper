...
source: https://developers.weixin.qq.com/minigame/dev/guide/game-engine/unity-webgl-transform/Design/SDKInstaller.html
---

# 微信SDK安装

  * 请查阅[推荐引擎版本](<https://developers.weixin.qq.com/minigame/dev/guide/game-engine/unity-webgl-transform/Design/UnityVersion.html>)，安装时选择 WeiXin MiniGame（团结引擎）或 WebGL（Unity引擎）组件
  ...
  * 查阅[快速开始：转换工具导出微信小游戏](<Transform.md>)进行小游戏导出转换
