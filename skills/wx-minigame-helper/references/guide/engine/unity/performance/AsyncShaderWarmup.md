---
title: "Shader 异步 Warmup"
type: guide
category: guide/engine/unity/performance
source: https://developers.weixin.qq.com/minigame/dev/guide/game-engine/unity-webgl-transform/Design/AsyncShaderWarmup.html
---
...
## 异步 Shader Warmup 使用条件
  ...
  4. 在小游戏的 `game.json` 文件中配置 `"enableParallelShaderCompile": true`
     * ![](https://res8.wxqcloud.qq.com.cn/wxdoc/922881f2-1c98-43de-ae4e-91c842e3519f.png)
