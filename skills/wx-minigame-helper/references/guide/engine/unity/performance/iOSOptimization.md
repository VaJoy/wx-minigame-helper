---
title: "iOS 高性能与高性能+模式"
type: guide
category: guide/engine/unity/performance
source: https://developers.weixin.qq.com/minigame/dev/guide/game-engine/unity-webgl-transform/Design/iOSOptimization.html
---
...
高性能+模式开创新地在保留游戏独立进程的基础上将渲染重新挪回了微信进程，这使得渲染效果和渲染内存消耗都得到了改善。详细文档请查阅[高性能+模式](<../../../performance/overview/perf-high-performance-plus.md>)。 特别地，建议使用WebGL2、内存压力大的游戏开启此选项。开启后请验证进程内存、渲染兼容性、帧耗时数据是否正常。
...
![](https://res8.wxqcloud.qq.com.cn/wxdoc/b23d282d-85af-41d8-a5b9-5d0bf2ebe126.png)
...
![](https://res8.wxqcloud.qq.com.cn/wxdoc/a52ec7d4-aaca-433b-914f-caced74e172e.png) ![](https://res8.wxqcloud.qq.com.cn/wxdoc/339d72f8-a671-4c59-9781-df17aefb7b4f.png)
...
iOS 端小游戏高性能模式适用于遇到 iOS 环境运行性能不足，运行发烫的小游戏。
  ...
  * 需要该能力的开发者登录[微信公众平台](<https://mp.weixin.qq.com>) -> 能力地图 -> 研发能力 -> 生产提效包 -> 点击开通高性能模式。 ![](https://res8.wxqcloud.qq.com.cn/wxdoc/004c9f5b-d7d5-4320-9bb3-ff16e9faa341.png)
...
**_上线发布时，特别建议使用[WASM 代码分包](<WasmSplit.md>)+[压缩纹理](<../assets/CompressedTexture.md>)+[UnityHeap](<OptimizationMemory.md>)预留这几种优化手段。_**
...
### 2\. 使用高性能模式下，游戏本身是否需要做修改？
  ...
  * Android 下载资源无问题，高性能模式提示资源下载失败等网络问题，请参考文档[网络通信适配](<../platform/UsingNetworking.md>)关于跨域的问题

### 3\. iOS 报错提示未开启 gzip/br 压缩 ![](https://res8.wxqcloud.qq.com.cn/wxdoc/0d7a71a7-945a-49b7-840b-4e5896fae23f.png)
...
![](https://res8.wxqcloud.qq.com.cn/wxdoc/873ceb63-996a-4e94-bc8e-6d64ec44e01d.png)

### 4\. 资源下载提示`isTrusted` ![](https://res8.wxqcloud.qq.com.cn/wxdoc/6b9a6cbf-9ba8-45c3-8f4f-9c978ee44a96.png)

多半由于跨域问题导致，可通过开发者工具查看对应资源的 Response Header 是否有跨域头， 请参考文档[网络通信适配](<../platform/UsingNetworking.md>)关于跨域的问题
...
### 5\. 卡在启动封面无法启动
  ...
  * 16.7/17.0系统出现"glGetString (GL_EXTENSIONS) - failure", 苹果官方17.1已fix。对于未更新系统的玩家，也可使用[高性能+模式](<../../../performance/overview/perf-high-performance-plus.md>)处理。详情请查阅: [Unity社区讨论](<https://forum.unity.com/threads/webgl-context-lost-ios-17-safari.1501193/>)，[iOS浏览器Webkit BUG](<https://bugs.webkit.org/show_bug.cgi?id=261313>),
...
### 8\. 使用高性能模式下，不优化内存、WASM 代码包体积就发布上线可以吗？ 
  ...
  * 不建议。iOS 高性能模式虽然能提运行算力，但对内存、WASM 包体积有更苛刻的要求，需要更多的精力做优化。如果不做任何优化的情况下，很有可能会遇到超出内存限制而崩溃，启动时发烫现象严重等问题。** _上线发布时，特别建议使用[WASM 代码分包](<WasmSplit.md>)+[压缩纹理](<../assets/CompressedTexture.md>)+[UnityHeap](<OptimizationMemory.md>)预留这几种优化手段。_**
