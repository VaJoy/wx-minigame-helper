---
title: "性能优化实战——使用Particle Budget系统优化粒子性能"
type: guide
category: guide/engine/unity/performance
source: https://developers.weixin.qq.com/minigame/dev/guide/game-engine/unity-webgl-transform/Design/ParticleBudget.html
---
...
![Particle Update](https://res8.wxqcloud.qq.com.cn/wxdoc/e1ae48b7-72a8-485d-b077-0a9457e03078.png)
...
![流程图](https://res8.wxqcloud.qq.com.cn/wxdoc/44f2a0b5-5a5f-45a2-972f-c0fe3cf3f8a7.png)
...
### 组件细节
  ...
  * `ParticleSystemController`组件 该组件与`Particle System`挂载在同一个GameObject下： ![Particle System Controller](https://res8.wxqcloud.qq.com.cn/wxdoc/ce6e3afc-9a78-4024-8008-50bdf8d0c582.png) `Priority Preset`可选：`Force Update`（强制更新）、`High Priority`（高优先级）、`Normal`(正常优先级)。

  * `ParticleSimulationBudgetManager`组件 该组件为一个全局单例： ![ParticleSimulationBudgetManager](https://res8.wxqcloud.qq.com.cn/wxdoc/9f300f31-d670-42dc-a29c-5170fa88a51a.png) 可以在这个组件中通过`Max Frame Budget MS`属性进行预算的设置（以毫秒为单位）。
...
![Perf Data](https://res8.wxqcloud.qq.com.cn/wxdoc/5994e410-2738-4986-89f8-a5d5498b27d4.png)
...
可以参考[Demo](<https://git.weixin.qq.com/wechat-minigame/minigame-tuanjie-demo/tree/master/Demo/particlebudget>)，开发者可根据项目需求灵活调整优先级计算策略和预算值。
