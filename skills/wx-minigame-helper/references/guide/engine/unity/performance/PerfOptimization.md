...
source: https://developers.weixin.qq.com/minigame/dev/guide/game-engine/unity-webgl-transform/Design/PerfOptimization.html
---
...
根据平台在不同游戏类型/机型下的评测，我们给出Unity WebGL小游戏可以参照的的[性能评估标准](<../profiling/PerfMeasure.md>)，开发者依此对游戏的启动与运行性能进行调优。
...
更多信息请参考：
  ...
  * [提升Unity WebGL游戏启动速度](<../startup/StartupOptimization.md>)
  * [首场景启动优化](<../startup/FirstSceneOptimization.md>)
...
更多信息请阅读:
  ...
  * [使用Addressable进行资源按需加载](<../assets/UsingAddressable.md>)
  * [使用 AssetBundle 进行资源按需加载](<../assets/UsingAssetBundle.md>)
  * [使用预下载功能](<../assets/UsingPreload.md>)
...
更多信息请阅读:
  ...
  * [资源优化工具与建议](<../assets/AssetOptimization.md>)
...
更多信息请阅读:
  ...
  * [压缩纹理优化](<../assets/CompressedTexture.md>)
...
更多信息请阅读:
  ...
  * [iOS 高性能与高性能+模式](<iOSOptimization.md>)
  * [使用Android CPU Profiler性能调优](<../profiling/AndroidProfile.md>)
  * [使用Unity Profiler性能调优](<../profiling/UnityProfiler.md>)
