...
source: https://developers.weixin.qq.com/minigame/dev/guide/runtime/js-support.html
---
...
小程序的 JS [执行环境](<env.md>) 在不同平台上的执行环境存在差异，因此导致不同平台对 ECMAScript 标准的支持存在差异。
...
也可以[查看支持度列表](<https://wechat-miniprogram.github.io/miniprogram-compat/>)
