...
source: https://developers.weixin.qq.com/minigame/dev/guide/performance/perf-webassembly.html
---

# WXWebAssembly  
  
WXWebAssembly 类似于 Web 标准 WebAssembly，能够在一定程度上提高小游戏的性能。

从基础库 v2.13.0 开始，小游戏可以在全局访问并使用 WXWebAssembly 对象。

从基础库 v2.15.0 开始，小游戏支持在 Worker 内使用 WXWebAssembly。
...
## 与 WebAssembly 的异同
  ...
  1. WXWebAssembly.instantiate(path, imports) 方法，path 为代码包内路径（支持.wasm 和.wasm.br 后缀）
...
## 其他说明
  ...
  * 小游戏插件从基础库 v2.18.1 开始支持 WXWebAssembly
