---
title: "wx.closeBluetoothAdapter(Object object)"
type: api
category: api/device/bluetooth
api: "wx.closeBluetoothAdapter"
...
关闭蓝牙模块。调用该方法将断开所有已建立的连接并释放系统资源。建议在使用蓝牙流程后，与 [wx.openBluetoothAdapter](<wx.openBluetoothAdapter.md>) 成对调用。
