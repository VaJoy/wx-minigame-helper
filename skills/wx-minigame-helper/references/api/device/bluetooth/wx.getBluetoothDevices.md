---
title: "wx.getBluetoothDevices(Object object)"
type: api
category: api/device/bluetooth
api: "wx.getBluetoothDevices"
...
## 注意
  ...
  * 该接口获取到的设备列表为**蓝牙模块生效期间所有搜索到的蓝牙设备** ，若在蓝牙模块使用流程结束后未及时调用 [wx.closeBluetoothAdapter](<wx.closeBluetoothAdapter.md>) 释放资源，会存在调用该接口会返回之前的蓝牙使用流程中搜索到的蓝牙设备，可能设备已经不在用户身边，无法连接。
