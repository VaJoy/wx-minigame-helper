---
title: "wx.startAccelerometer(Object object)"
type: api
category: api/device/accelerometer
api: "wx.startAccelerometer"
...
---|---|---|---|---|---|---  
|  interval | string | normal | 否 | 监听加速度数据回调函数的执行频率 | [2.1.0](<../../../guide/runtime/client-lib/compatibility.md>)  
| |  合法值 | 说明  
---|---  
