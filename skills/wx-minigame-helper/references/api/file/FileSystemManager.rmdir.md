---
title: "FileSystemManager.rmdir(Object object)"
type: api
category: api/file
api: "FileSystemManager.rmdir"
...
recursive | boolean | false | 否 | 是否递归删除目录。如果为 true，则删除该目录和该目录下的所有子目录以及文件。 | [2.3.0](<../../guide/runtime/client-lib/compatibility.md>)  
