---
title: "FileSystemManager.stat(Object object)"
type: api
category: api/file
api: "FileSystemManager.stat"
...
recursive | boolean | false | 否 | 是否递归获取目录下的每个文件的 Stats 信息 | [2.3.0](<../../guide/runtime/client-lib/compatibility.md>)  
...
属性 | 类型 | 说明  
---|---|---  
stats | [Stats](<Stats.md>)/Array.<[FileStats](<FileStats.md>)> | 当 recursive 为 false 时，res.stats 是一个 Stats 对象。当 recursive 为 true 且 path 是一个目录的路径时，res.stats 是一个 Array，数组的每一项是一个对象，每个对象包含 path 和 stats。  
